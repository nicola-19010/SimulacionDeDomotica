...
public class Cliente {
    private static final String HOST = "controlador";
    ...
    private void realizarSolicitud(String solicitud) {
        //prueba con try-with-resources los recursos. No es necesario utilizar bloques finally ni llamar manualmente a los métodos close()
        // para cada recurso.
